                ...
                <form action="<?= BASEURL; ?>/alternatif/store" method="POST">
                    ...
                    <div class="space-y-8">
                        <div>
                            ...
                            <input type="text" class="w-full px-4 py-2 border border-slate-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none transition-all bg-slate-50" id="nama" name="nama" placeholder="Nama Lengkap" autofocus required>
                        </div>
                            ...
                            <div class="space-y-2">
                                <?php foreach ($data['c1'] as $key) : ?>
                                    <div class="flex items-center">
                                        <input class="w-4 h-4 text-blue-600 border-slate-300 focus:ring-blue-500" type="radio" name="c1" id="c1_<?= $key['id_sub']; ?>" value="<?= $key['id_sub']; ?>" required>
                        ...
                        <div class="border-t border-slate-100 pt-6">
                            ...
                            <div class="space-y-2">
                                <?php foreach ($data['c2'] as $key) : ?>
                                    <div class="flex items-center">
                                        <input class="w-4 h-4 text-blue-600 border-slate-300 focus:ring-blue-500" type="radio" name="c2" id="c2_<?= $key['id_sub']; ?>" value="<?= $key['id_sub']; ?>" required>
                        ...
                        <div class="border-t border-slate-100 pt-6">
                            ...
                            <div class="space-y-2">
                                <?php foreach ($data['c4'] as $key) : ?>
                                    <div class="flex items-center">
                                        <input class="w-4 h-4 text-blue-600 border-slate-300 focus:ring-blue-500" type="radio" name="c4" id="c4_<?= $key['id_sub']; ?>" value="<?= $key['id_sub']; ?>" required>
                        ...
                        <div class="border-t border-slate-100 pt-6">
                            ...
                            <div class="space-y-2">
                                <?php foreach ($data['c5'] as $key) : ?>
                                    <div class="flex items-center">
                                        <input class="w-4 h-4 text-blue-600 border-slate-300 focus:ring-blue-500" type="radio" name="c5" id="c5_<?= $key['id_sub']; ?>" value="<?= $key['id_sub']; ?>" required>
                        ...
                        <div class="border-t border-slate-100 pt-6">
                            ...
                            <div class="space-y-2">
                                <?php foreach ($data['c6'] as $key) : ?>
                                    <div class="flex items-center">
                                        <input class="w-4 h-4 text-blue-600 border-slate-300 focus:ring-blue-500" type="radio" name="c6" id="c6_<?= $key['id_sub']; ?>" value="<?= $key['id_sub'] ?>" required>
                    ...
                    <div class="mt-8 flex justify-end gap-3">
                        ...
                        <button type="submit" class="px-6 py-2.5 bg-primary text-white rounded-lg hover:bg-blue-700 font-medium shadow-sm shadow-blue-200 transition-colors">Simpan</button>
                    </div>
                </form>
            </div>
        </div>
